...
export default () => html`
  <section id="bio">
    ...
    <p class="about">
      ...
      was not properly evaluating talent. I found I was unable to properly
      evaluate talent due to a lack of available time. Although I enjoy Fantasy
      Football it couldn't be prioritized over other responsibilities (ex.lawn
      work, job, kids, etc.) and that's when Farfan Fantasy Football was born.
      Farfan Fantasy Football was created to help Fantasy Football players that
      want an advantage over their league mates, but can't pour through the
      film/data themselves. Farfan Fantasy Football provides the best of both
      world and has scores for incoming rookies based on both film and metrics.
    </p>
  </section>
`;
